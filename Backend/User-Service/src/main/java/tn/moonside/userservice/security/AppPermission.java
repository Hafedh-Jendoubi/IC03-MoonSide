...
public final class AppPermission {
    ...
    // =========================================================================
    // These are stored in the shared `permissions` collection and surfaced in the
    // admin/roles page exactly like the permissions above. The Post-Service
    // enforces them via hasRole() in its own SecurityConfig; the User-Service
    // stores them so they can be assigned to / revoked from roles in the UI.
    ...
    /** GET /posts/feed, /posts/author/**, /posts/team/**, /posts/{id} — read posts */
    public static final String POST_READ             = "POST_READ";

    /** PUT /posts/{id} — edit own post (author ownership enforced in service) */
    ...
    /** DELETE /posts/{id} — delete ANY post (moderation — CEO or HR) */
    ...
    /** GET /posts/{id}/comments — read comments and replies */
    ...
    /** POST/GET /posts/{id}/reactions — react to or view reactions on a post */
    public static final String REACTION_POST         = "REACTION_POST";

    /** POST/GET /posts/{id}/comments/{cid}/reactions — react to or view reactions on a comment */
    ...
    /** GET/POST/DELETE /posts/saved/** — bookmark/unbookmark posts */
    public static final String POST_SAVE             = "POST_SAVE";

    // ─── Surveys ─────────────────────────────────────────────────────────────

    /** POST /posts/{id}/survey/vote — cast or change vote on a survey post */
